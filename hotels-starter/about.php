    ...
    <div class="container py-lg-5 py-sm-4">
        <div class="maghny-gd-1">
            <div class="row about-text">
                ...
                <div class="col-lg-6">
                    <p>Stay Inn Hotels global enterprise boasts approximately 4,300 hotels in over 100 countries and territories worldwide. With 19 unique brands across every chain scale segment, from economy to luxury, Stay Inn Hotels suits the needs of developers and guests in every market as each brand offers its own personality and style.</p>
                    <p class="mt-3">Discover more information about this iconic enterprise including information on the executive team, who are recognized throughout the industry and beyond for their leadership and vision; the company’s commitment to supporting local charitable efforts around the world; and information for developers interested in adding one of these brands to their portfolio.
            ...
            <div class="row mt-5">
                ...
                <div class="maghny-gd-1 col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius">
                            <img src="assets/images/about2.jpg" height="240px">
                            <figcaption class="w3set-hny">
                                <div>
                ...
                <div class="maghny-gd-1 col-lg-4 col-md-6 mt-lg-0 mt-4">
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius">
                            <img src="assets/images/about3.jpg" height="240px">
                            <figcaption class="w3set-hny">
                                <div>
        ...
        <div class="container py-lg-4 py-md-3">
            ...
            <div class="row w3-services-grids">
                <div class="col-lg-9 w3-services-right-grid pl-lg-5 mx-auto">
                    <h4 class="mb-md-5 mb-4">What the guests can expect from our hotels</h4>
                    <div class="fea-gd-vv row">
                        <div class="col-md-6">
                            <div class="float-lt feature-gd">
                                ...
                                <div class="icon-info">
                                    <h5>Welcome Drink</h5>
                                    <p> enjoy a complimentary drink once you arrive for your stay at the hotel just before you check-in </p>
                        ...
                        <div class="col-md-6 mt-md-0 mt-4">
                            <div class="float-mid feature-gd">
                                ...
                                <div class="icon-info">
                                    <h5>Bike Rental</h5>
                                    <p> for guests looking for adventure whilst they stay with us we have the service of bike hire, the people who want to explore the surrounding area are able to get bikes for duration of their choice. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mt-4 pt-md-2">
                            <div class="float-rt feature-gd">
                                ...
                                <div class="icon-info">
                                    <h5>WIFI Areas</h5>
                                    <p>All the hotels locations of our branch are WI-FI accessiblefor people to stay in touch with the world even in rural areas. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mt-4 pt-md-2">
                            <div class="float-lt feature-gd">
                                ...
                                <div class="icon-info">
                                    <h5>Swimming Pool</h5>
                                    <p>Almost all of our hotel location have swimming pools in them, which is usually complimentary with any of the bookings that you may do whether it is a standard room booking or a delux room booking. </p>
        ...
        <div class="container py-lg-3">
            <div class="row align-items-center">
                <div class="col-lg-6 title">
                    <h3 class="title-big">We have been in this service for many years now </h3>
                    <p class="mt-4">being in the Hotel business for as long as we have has taught us very valuable lessons and it also helped us achieve very good goals. We dont treat our customers as just a number but we treat them as a unique individual with their own unique interest and needs. Here are some of statistics that we have achieved over the years of us providing service.</p>
                </div>
                    ...
                    <div class="owl-testimonial owl-carousel owl-theme">
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                ...
                                <div class="message">Here at Best Inn we prioritise our customers request in order to get repeated business from them. whether they stay for a day or a Week.</div>
                        ...
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                ...
                                <div class="message">Joined venture that we had started years ago has only come so far because of the dedication of everyone involved.</div>
                        ...
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                ...
                                <div class="message">Treat every employee as part of your family because they are learning just as you have done in the past</div>
                        ...
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                ...
                                <div class="message">Starting form house keeping and making it all the way to a branch manager made me realise that anything is possible if you are dedicated enough towards a cause.</div>
...
<section class="w3l-footer-29-main w3l-copyright">
  <div class="container">
    <div class="row bottom-copies">
      <p class="col-lg-8 copy-footer-29">Designed by Parabhjot Singh<a>
