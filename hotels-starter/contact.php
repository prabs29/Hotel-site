        ...
        <div class="container">
            <div class="d-grid contact-view">
                ...
                <div class="map-content-9">
                    <p>For any enquiries and information about any of our services you can contaact us from your preferred method, whether its over the phone, email or even social media. Here you will find all of our contact details including where our branch is located.</p>
                </div>
            </div>
            <div class="map-iframe my-5">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d154965.23476829016!2d-1.4264385033330993!3d52.63591836124919!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487742ab49b76c73%3A0x9a151d2a6fb49cb8!2sLeicester%2C%20UK!5e0!3m2!1sen!2sin!4v1716273718051!5m2!1sen!2sin" width="100%" height="300" frameborder="0" style="border: 0px; pointer-events: none;"
                ...
                <div class="cont-details">
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p><a href="tel:+44 99 555 42">+44 73344 40923</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p><a href="mailto:example@mail.com" class="mail">prabh@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                        ...
                        <div class="cont-right">
                            <h6>Address</h6>
                            <p>Stay Inn hotel, leicester, LE1 1EA, UK.</p>
                        </div>
                    </div>
                </div>
  ...
  
{
    ...
    $query = "INSERT INTO contact2 values('$name', '$email', '$subject', '$message')";
