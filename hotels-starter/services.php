                    ...
                    <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                        <div class="features-with-17-right-tp_sur">
                            ...
                            <div class="features-with-17-left2">
                                ...
                                <p>Use our pool to either relax or do an intense workout whatever suits your need included in the room price.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-lg-0 mt-sm-5 mt-4">
                        <div class="features-with-17-right-tp_sur">
                            ...
                            <div class="features-with-17-left2">
                                ...
                                <p>Use our inhouse restaurant to grab a bite or a full meal both of which are delicious</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-sm-5 mt-4">
                        <div class="features-with-17-right-tp_sur">
                            ...
                            <div class="features-with-17-left2">
                                ...
                                <p>Always stay connected to the world whenever you stay with us with high speed WiFi</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-sm-5 mt-4">
                        <div class="features-with-17-right-tp_sur">
                            ...
                            <div class="features-with-17-left2">
                                ...
                                <p>Book a treatment day or just a small session to make your worries and stress fly away at our spa center</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-sm-5 mt-4">
                        <div class="features-with-17-right-tp_sur">
                            ...
                            <div class="features-with-17-left2">
                                ...
                                <p>Do not hesitate to call the front desk for any assistance at any time of the day, there will always be someone to listen to your request</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="middle-section row mt-lg-5 pt-md-3">
                <div class="three-grids-columns col-lg-4 col-md-6">
                    ...
                    <div class="info">
                        ...
                        <p>So many options to choose from yuo will find it hard to decide what you should get to eat </p>
                ...
                <div class="three-grids-columns col-lg-4 col-md-6 mt-md-0 mt-4">
                    ...
                    <div class="info">
                        ...
                        <p>We also host corporate meetings and events as well as usual customer who come to relax and have a little holiday</p>
                        <a href="services.html" class="btn mt-4">Read More </a>
                    </div>
                </div>
                <div class="three-grids-columns col-lg-4 col-md-6 mt-lg-0 mt-4">
                    ...
                    <div class="info">
                        ...
                        <p>Our spa is one of the top rated in the country with the staff who has years of knowledge </p>
                        <a href="services.html" class="btn mt-4">Read More </a>
                    </div>
                </div>
      ...
      <div class="row footer-top-29">
        ...
        <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-4 mt-lg-0 mt-5">
          ...
          <form action="#" class="subscribe" method="post">
            ...
            <button><span class="fa fa-envelope-o"></span><input type="Submit" value="Send" name="submit"></button>
          </form>
        </div>
      </div>
    </div>
  ...
  
{
    ...
    $query = "INSERT INTO subs values('$email')";
